...
class ErrorCompany {
  returnError(error) {
    ...
    if (errName === "ProtocolError" || errMsg.includes("ERR_ABORTED") || errMsg.includes("ERR_TOO_MANY_REDIRECTS")) return new UndefinedError().getError(); //protocol: lỗi link, err_aborted: request timeout
  }
}
